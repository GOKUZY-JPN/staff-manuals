...
池に向かって**柏手を打ち、こだまが返ってくる方向**に「行方不明の人や探し物の手がかりがある」という言い伝えが江戸時代以降から伝わっている。

**なぜこの言い伝えが生まれたのか？**

| 理由 | 説明 |
|------|------|
| 音の反響 | 池が山・石垣に囲まれた地形のため、柏手のこだまが特定の方向から返ってくる。その方向性を「運命の示し」と読み取った |
| 水場への信仰 | 池は古来「水の神」や「占いの媒介」として信仰され、熊鷹社（勝負事・商売繁盛の神）との組み合わせで「水を通じてヒントが返ってくる」イメージが定着 |
| 民俗的な需要 | 家出・失踪が多かった時代に「どちらに探しに行くか」を示す占いの場として実用的に使われた |

**ゲストへの体験案内：**
1. 池に向かって静かに立つ
2. 心の中で「探しているもの・叶えたいこと」を念じる
3. 柏手を一度打ち、こだまが返ってくる方向に耳を澄ます

> 💬 **ガイドの一言例：**
> *"This pool has a name that means 'echo.' For centuries, people came here searching for lost loved ones — they'd clap their hands and listen for the echo to tell them which direction to search. It's a beautifully human kind of magic, don't you think?"*
